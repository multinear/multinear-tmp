...
def handle(args):
    ...
    try:
        for update in run_experiment(project.to_dict(), job_id):
            ...
            status_table.add_column("Status", justify="left", style="cyan", no_wrap=True)
    ...
    details_message = f"For detailed information about this run, use: multinear details {job_id[-8:]}"
