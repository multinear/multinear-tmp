...
def add_parser(subparsers):
    parser = subparsers.add_parser('details', help='Show detailed information about a specific run')
...
def find_run_by_partial_id(partial_id: str) -> Optional[JobModel]:
    ...
    jobs = JobModel.list_recent(project.id, limit=100)  # Increase limit to search more runs
