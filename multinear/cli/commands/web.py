...
def add_parser(subparsers):
    ...
    parser_web_dev = subparsers.add_parser('web_dev', help='Start development web server with auto-reload')
...
def handle(args):
    ...
    console = Console()
    console.print(f"Starting {'development' if args.command == 'web_dev' else 'production'} server on {args.host}:{args.port}")
